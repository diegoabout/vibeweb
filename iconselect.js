    ...
    _View.createUI = function($parameters){
        ...
        <div id="my-icon-select" class="icon-select">
            <div class="selected-box">
                <div class="selected-icon"><img src="i2.png"></div>
                <div class="component-icon"><img src="arrow.png"></div>
                <div class="box">
                    <div class="icon"><img src="i1.png"></div>
                    <div class="icon selected"><img src="i2.png"></div>
                    <div class="icon"><img src="i3.png"></div>
                    <div class="icon"><img src="i4.png"></div>
                    <div class="icon"><img src="i3.png"></div>
                    <div class="icon"><img src="i4.png"></div>
                    <div class="icon"><img src="i5.png"></div>
                    <div class="icon"><img src="i6.png"></div>
                    <div class="icon"><img src="i7.png"></div>
                    <div class="icon"><img src="i8.png"></div>
                </div>
            </div>
        </div>
